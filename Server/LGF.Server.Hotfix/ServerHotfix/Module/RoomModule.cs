...
namespace LGF.Server.Hotfix
{
    public class RoomModule : ModuleBase
    {
        ...
        protected override void OnInit()
        {
            ...
            RegisterServerMsg<C2S_CreateRoom>(OnCreateRoom);
            RegisterServerMsg<C2S_InformRoomChange>(OnRoomChange);
            RegisterServerMsg<C2S_GetAllTheRooms>(OnGetAllTheRooms);
            RegisterServerMsg<C2S_RoomProgress>(OnRoomProgress, false);
        }
        ...
        void OnCreateRoom(KcpServer.KcpSession session, C2S_CreateRoom c2S_CreateRoom)
        {
            ...
            Room room = roomMgr.CreateRoom(player);
        ...
        void OnRoomChange(KcpServer.KcpSession session, C2S_InformRoomChange msg)
        {
            ...
            if (player == null)
            {
                sLog.Debug(" session.playerID  si {0}", session.useid);
                return;
            }
            int optType = msg.opt;
        ...
        /// 检查开始加载
        /// </summary>
        void CheakStartLoading(Room room)
        {
