...
public class NewBehaviourScript : MonoBehaviour
{
    ...
    void Start()
    {
        sLog.Error(Regex.Replace("<img>abc</img>", @"<img>(?<11111>.*?)</img>", "[图片]${11111}"));
        ...
        sLog.Error(Regex.Replace(val5, @"\\", "/"));



        sLog.Debug(@"LGF.EventDispatcher`1[LGF.EvtHelper+IOnUpdate]:Fire() (at Assets/_Test/Lh2/LHLGF/_LGF/Manager/Helper/Event/EventDispatcher.cs:117)
