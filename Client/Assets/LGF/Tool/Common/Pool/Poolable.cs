...
namespace LGF
{
    ...
    public class PoolableNotLock<T> : System.IDisposable where T : PoolableNotLock<T>, new()
    {
        [System.NonSerialized]
        private static readonly ObjectPoolNotLock<T> _pool = new ObjectPoolNotLock<T>(_OnGet, _OnRelease);
        ...
        static void _OnRelease(PoolableNotLock<T> _this)
        {
            _this.OnRelease();
        }
        static void _OnGet(PoolableNotLock<T> _this)
        {
            _this.OnGet();
        }
