    ...
    public class JsonReader
    {
        ...
        private void ProcessNumber (string number)
        {
            if (number.IndexOf ('.') != -1 ||
				...
				if (Double.TryParse(number, System.Globalization.NumberStyles.Number|System.Globalization.NumberStyles.AllowExponent, System.Globalization.CultureInfo.InvariantCulture, out n_double)) {
#else
